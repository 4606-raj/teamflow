...
export class OrganizationsController {
    ...
    @Post('/add-member')
    addMember(@Body() data: {userId: string, email: string, organizationId: string}) {
        return this.organizationService.addMember(data.userId, data.email, data.organizationId);
    }
}
